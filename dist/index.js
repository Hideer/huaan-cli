...
program.version(require('../package').version).usage('<command> [options]'); // program.command('list', 'list all the templates').action(() => {
//   console.log('000');
//   require('./list')()
// })
...
program.command('list').description('list all the templates').action(() => {
  require('./list')();
});
